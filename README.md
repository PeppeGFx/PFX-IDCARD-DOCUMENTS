...
# PFX-IDCARD
#visit our store https://peppegfx.tebex.io/
#for support join our discord channel https://discord.gg/yhhf6Jjv
...
put resource to your resources files and go to server.cfg after that type ensure pfx_idcard
...
local shot = exports['pfx_idcard']:GetBase64(PlayerPedId())
TriggerServerEvent("pfx_idcard:server:createCard", shot, "citizen")

for driver license : 

local shot = exports['pfx_idcard']:GetBase64(PlayerPedId())
TriggerServerEvent("pfx_idcard:server:createCard", shot, "driver") 

for weapons license : 

local shot = exports['pfx_idcard']:GetBase64(PlayerPedId())
TriggerServerEvent("pfx_idcard:server:createCard", shot, "weapon") 
